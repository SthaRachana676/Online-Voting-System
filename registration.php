  ...
  <body>
    ...
    <div class="container" style="padding-top:100px;">
    	<div class="row">
    		...
    		<div class="col-sm-4" style="border:3px solid black;padding:15px;">
            <br>
        <center>
        <legend> <h3> Registration </h3></legend> </center>
        ...
        <form action= "cap_reg.php" method= "post" id="myform" >
        <div class="form-group">
        <label>Voter ID:</label> <br>
        <input type="text" name ="voter_id" placeholder="Enter your voter ID" class="form-control">
        <br>
        <label>Voter Email</label><br>
      	<input type="text" name = "email" class="form-control" placeholder="Enter  voter email"><br>
        <label>Password</label><br>
        <input type="password" name ="pswd" class="form-control" placeholder="Enter Your Password "><br>
        ...
        frmvalidator.addValidation("vname","req","Please enter voter name"); 
        frmvalidator.addValidation("vname","maxlen=50");
        frmvalidator.addValidation("email","req","Please enter voter email"); 
