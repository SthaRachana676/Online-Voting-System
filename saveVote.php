...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="padding-top:150px;">
       ...
       $DB_USER="root";
       $DB_PASSWORD="";
       $DB_NAME="project_voting";
	

        $conn= @mysqli_connect($DB_HOST,$DB_USER,$DB_PASSWORD,$DB_NAME)
        or die("Couldn't Connect to Database :");

				$sql= "INSERT INTO project_voting.tbl_users  (`full_name`, `email`,`voter_id`,`voted_for`) VALUES('$name','$email','$voterID','$selection');";
