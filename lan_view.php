    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          ...
          <span class="normalFont"><a href="admin.php" class="btn btn-success navbar-right navbar-btn"><strong>Logout</strong></a></span>
        </div>
      </div> 
    </nav>
    </div> -->
    ...
    ?>
      <font size='5'>
        <table id="result_table" width="100%">
          <tr class="helloTH">
            <th width="8%">ID</th>
            <th width="42%">CANDIDATES</th>
            <th width="42%" style="text-transform:uppercase;">party</th>
            <th width="8%">VOTE</th>
          </tr>
          <?php
